(function (app) {
    app.controller('analyticExistListController', function ($scope, commonService, apiService, notificationService) {
        $scope.pageSize = 5;
        ...
        function exportData() {
            ...
            window.location.href = "/Dashboard/Export?StartTime=" + start + "&EndTime=" + end + "&Exits=true";
