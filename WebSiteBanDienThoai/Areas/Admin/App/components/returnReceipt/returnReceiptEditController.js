(function (app) {
    app.controller('returnGuaranteeEditController', function ($scope,$state, $stateParams,$http, commonService, apiService, notificationService) {
        $scope.properties = {
            title: "Chỉnh sửa",
        ...
        $scope.methods = {
            ...
            _edit: function (id, name) {
                ...
                apiService.post('EditPay', $scope.properties.obj,
                function (result) {
        ...
        function Init() {
            ...
            apiService.get('GetPay?Id='+$stateParams.ID, null, function (result) {
